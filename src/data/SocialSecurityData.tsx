...
const SS_WAGE_BASE: Record<number, number> = {
  // Historical SSA contribution and benefit base (official published values).
  // Source: SSA Contribution and Benefit Base https://www.ssa.gov/oact/cola/cbb.html
  // Needed so pre-2000 auto-generated (no SSA import) earnings are capped at the year's
  // real cap instead of falling back to the 2000 base ($76,200) — the earliest-year
  // fallback in lookupYearlyData over-caps early-career earnings before wage indexing.
  1951: 3600,
  1952: 3600,
  1953: 3600,
  1954: 3600,
