...
describe('useSimulation - runSimulation', () => {
    ...
    describe('Life Expectancy Capping', () => {
        it('should cap simulation at life expectancy', () => {
            ...
            const result = runSimulation(30, [], [], [], shortLifeAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should return only Year 0 when already at life expectancy', () => {
            ...
            const result = runSimulation(30, [], [], [], atEndAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should run full duration when life expectancy is far out', () => {
            ...
            const result = runSimulation(10, [], [], [], longLifeAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
    ...
    describe('Monte Carlo Return Overrides', () => {
        it('should apply yearly return overrides when provided', () => {
            ...
            const result = runSimulation(2, [account], [], [], baseAssumptions, baseTaxState, yearlyReturns, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should use default assumptions when no return override provided', () => {
            ...
            const result = runSimulation(2, [account], [], [], baseAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should handle partial return overrides array', () => {
            ...
            const result = runSimulation(3, [account], [], [], baseAssumptions, baseTaxState, yearlyReturns, { referenceDate: new Date(2025, 11, 31) });
    ...
    describe('Timeline Continuity', () => {
        it('should pass previous timeline to each year for SS calculation', () => {
            ...
            const result = runSimulation(5, [], incomes, [], assumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should carry forward account balances year to year', () => {
            ...
            const result = runSimulation(3, [account], [], [], baseAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should carry forward income/expense modifications', () => {
            ...
            const result = runSimulation(3, [], incomes, [], assumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
    ...
    describe('Edge Cases', () => {
        it('should handle empty inputs', () => {
            const result = runSimulation(5, [], [], [], baseAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should handle zero years requested', () => {
            const result = runSimulation(0, [], [], [], baseAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
        ...
        it('should handle negative years gracefully', () => {
            ...
            const result = runSimulation(10, [], [], [], pastAssumptions, baseTaxState, undefined, { referenceDate: new Date(2025, 11, 31) });
