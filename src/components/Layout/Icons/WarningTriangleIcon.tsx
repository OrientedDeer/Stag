 ...
 * via text color, and `className` is spread onto the <svg> for sizing/color. Used by
 * IncomeCard, AlertBanner (warning severity), ConfirmDialog (danger + warning variants),
 * QRGenerateModal, and PriorityTab.
 */
